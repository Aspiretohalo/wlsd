...
const cancelActivityCommentThumb = async (item_id: any, activity_id: any) => {
    try {
        const response = await myAxios.post('/cancelActivityCommentThumb', {
            id: item_id,
            userId: user.userId
        }, {
            headers: {
...
export default cancelActivityCommentThumb;